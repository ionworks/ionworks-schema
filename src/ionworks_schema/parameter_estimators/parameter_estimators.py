...
class AskTellOptimizer(BaseSchema):
    ...
    xtol: Any | None = Field(default=1e-6)
    population_convergence_tol: Any | None = Field(default=5e-3)
    flat_fitness_tol: Any | None = Field(default=None)
    convergence_patience: Any = Field(default=3)
