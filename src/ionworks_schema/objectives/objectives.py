...
_DATA_INPUT_DESCRIPTION = (
    "Data to fit the objective against. Either a string path to a data file, "
    "or a dict with keys ``data`` (a DataFrame of raw values) and "
    "``metadata`` (dict of metadata about the data)."
)
_GENERIC_OPTIONS_DESCRIPTION = (
    "Dictionary of objective-specific options passed to the pipeline "
    "objective (e.g. the pybamm model, simulation kwargs, objective "
    "variables). Keys and defaults are documented per subclass."
)
_CALLBACKS_DESCRIPTION = (
    "A single callback or list of callbacks whose methods are invoked at "
    "various points during the data-fit process."
)
...
_COST_DESCRIPTION = (
    ...
    "GaussianLogLikelihood). If None, the optimizer's default cost "
    "function is used."
)
_CONSTRAINTS_DESCRIPTION = (
    "List of equality and inequality ``Constraint`` terms enforced on the "
    "objective during fitting."
)
_PENALTIES_DESCRIPTION = (
    "List of ``Penalty`` terms added as soft penalties to the objective cost."
)
_PARAMETERS_DESCRIPTION = (
    "Objective-specific parameter values merged into the global "
    "``ParameterValues`` before fitting. Default is None."
)
_ELECTRODE_DESCRIPTION = "Electrode to fit, either ``'positive'`` or ``'negative'``."
...
class BaseObjective(BaseSchema):
    ...
    custom_parameters : dict, optional
        A dictionary of custom parameters to use for the objective.
    ...
    parameters : dict or :class:`pybamm.ParameterValues`, optional
        ...
        before fitting. Default is None."""

    options: Any | None = Field(
        default=None,
        description=(
            "Dictionary of objective-specific options passed to the pipeline objective "
            "(e.g. the pybamm model, simulation kwargs, objective variables). Keys and "
            "defaults are documented per subclass."
        ),
    )
    callbacks: Any | None = Field(default=None, description=_CALLBACKS_DESCRIPTION)
    custom_parameters: Any | None = Field(
    ...
    constraints: Any | None = Field(default=None, description=_CONSTRAINTS_DESCRIPTION)
    penalties: Any | None = Field(default=None, description=_PENALTIES_DESCRIPTION)
    parameters: Any | None = Field(default=None, description=_PARAMETERS_DESCRIPTION)
...
class FittingObjective(BaseObjective):
    ...
    data_input: Any = Field(..., description=_DATA_INPUT_DESCRIPTION)
    options: Any | None = Field(
        default=None,
        description=(
            "Dictionary of objective-specific options passed to the pipeline "
    ...
    cost: Any | None = Field(default=None, description=_COST_DESCRIPTION)
    constraints: Any | None = Field(default=None, description=_CONSTRAINTS_DESCRIPTION)
    penalties: Any | None = Field(default=None, description=_PENALTIES_DESCRIPTION)
    parameters: Any | None = Field(default=None, description=_PARAMETERS_DESCRIPTION)
...
class CurrentDriven(SimulationObjective):
    ...
    options: Any | None = Field(
        ...
        description=(
            ...
            "current interpolant), ``interactive_preprocessing`` (bool — adjust "
            "interpolant tolerances based on data; default False), and "
...
class CycleAgeing(SimulationObjective):
    ...
    options: Any | None = Field(
        ...
        description=(
            ...
            "model), ``experiment`` (pybamm experiment), and ``objective "
            ...
            'provided for "LLI [%]", "LAM_ne [%]", "LAM_pe [%]") and '
            "``simulation_kwargs`` (kwargs forwarded to ``iwp.Simulation``)."
        ),
    )
    callbacks: Any | None = Field(default=None, description=_CALLBACKS_DESCRIPTION)
    custom_parameters: Any | None = Field(
...
class DesignObjective(BaseObjective):
    ...
    validate_against_experiment_steps: Any = Field(
        default=True,
        description=(
    ...
    output_variables_full: Any | None = Field(
        default=None,
        description=(
...
class EIS(FittingObjective):
    ...
    This objective uses PyBaMM's built-in EIS functionality to simulate the experiment
...
class ElectrodeBalancingHalfCell(FittingObjective):
    ...
    electrode: Any = Field(..., description=_ELECTRODE_DESCRIPTION)
    data_input: Any = Field(..., description=_DATA_INPUT_DESCRIPTION)
    options: Any | None = Field(
        default=None,
        description=(
...
class Resistance(FittingObjective):
    ...
    Parameters
    ----------
    data_input : pd.DataFrame, polars.DataFrame, or ionworksdata.DataLoader
