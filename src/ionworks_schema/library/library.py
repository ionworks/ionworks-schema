...
class Material(BaseModel):
    ...
    Mirrors ``iwp.library.Material``. Holds a named parameter set — the
    three thermodynamic host-site fields for MSMR-style materials, or any
    other pybamm-compatible parameter values for the material.
    """
...
class Library(BaseModel):
    ...
    Mirrors ``iwp.library.Library``. Exposes the bundled set of reference
    materials (e.g. graphite, NMC, LFP) via static lookups by name.
    """
