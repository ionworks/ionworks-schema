...
class TimeRangeSpec(BaseSchema):
    ...
    wall-clock datetimes, so a window stays meaningful for a measurement with
    no recorded start. Step selection comes first: ``first_step`` picks from
    the whole measurement, and the window narrows within the steps it chose.
